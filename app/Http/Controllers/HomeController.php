...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home', compact("saving_types", "challenges", "finish_challenges", "zero_challenges"));
        //dd($challenges);
    }
    ...
    private function getFinishChallenges()
    {
        ...
        for ($i = 0; $i < $challenges; $i++) {
            $this->finish_challenges += DB::table('savings')
